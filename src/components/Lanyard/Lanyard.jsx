...
<group position={[0, 4, 0]}>
  ...
  <RigidBody position={[0, -0.5, 0]} ref={j1} {...segmentProps}><BallCollider args={[0.1]} /></RigidBody>
  <RigidBody position={[0, -1, 0]}   ref={j2} {...segmentProps}><BallCollider args={[0.1]} /></RigidBody>
